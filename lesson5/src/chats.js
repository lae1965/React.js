...
function Chats() {
    ...
    const sendMessage = useCallback((message) => {
        setMessageList(prevMessage => ({
            ...prevMessage,
            [chatId]: [...prevMessage[chatId], message]
        }));
    }, [chatId]);
        ...
        <div className = "App">
            <div className = "App-left">
                <Button onClick = { addChat } variant = "contained" color = "primary"> Add new chat </Button> 
                {
                    ...
                    <Button 
                        ...
                        variant = "contained"
                        color = "primary">Delete current chat
                    </Button>
                } 
            ...
            <header className = "App-header"> 
            {
                ...
                <>
                    ...
                    { messageList[chatId].map((message, i) => <Message key = { i } text = { message.text }/>) } 
                </>    
            } 
            </header> 
        </div>
